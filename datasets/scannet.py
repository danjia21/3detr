...
DATASET_ROOT_DIR = "data/scannet/scannet_train_detection_data"  ## Replace with path to dataset
DATASET_METADATA_DIR = "./data/scannet/meta_data" ## Replace with path to dataset
